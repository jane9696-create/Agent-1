...
This is a **portable demo** of the AgentOrg multi-agent orchestration system. It contains three teams:

- `agents/agent-ops/` — Agent system management
- `agents/edu/` — Educational content production
- `agents/qsd/` — QSD compliance review (medical device quality documentation)
...
2. Open Claude Code with cwd set to this folder — `/tuq-edu`, `/tuq-agent`, and `/mrs-qsd-standard` auto-load
...
├── agents/qsd/              # QSD compliance review team
│   ├── manager/             # Orchestrates 5-step QSD review workflow
│   ├── document-collector/  # Step 1: Generate document request list from QSD checklist
│   ├── compliance-checker/  # Step 2: Compare received docs vs QSD checklist requirements
│   ├── sop-renamer/         # Step 3: Rename SOPs to "number@subject@version" format
│   ├── list-comparator/     # Step 4: Cross-compare SOPs vs manufacturer's SOP lists
│   └── form-filler/         # Step 5: Fill QSD app form-E-Annex 2 (ISO 13485:2016)
...
- `/mrs-qsd-standard` — All QSD compliance review work (medical device quality documentation)
